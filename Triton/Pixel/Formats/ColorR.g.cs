...
public record struct ColorR<T> : IColor<ColorR<T>, T> where T : unmanaged, INumberBase<T>, IMinMaxValue<T>
{
	...
	public readonly T G
	{
		get => Triton.Pixel.NumericConversion.GetMinimumValueSafe<T>();
		set { }
	}
	...
	public readonly T A
	{
		get => Triton.Pixel.NumericConversion.GetMaximumValueSafe<T>();
		set { }
	}
	...
	public static ColorR<T> Black => new(Triton.Pixel.NumericConversion.GetMinimumValueSafe<T>());
	public static ColorR<T> White => new(Triton.Pixel.NumericConversion.GetMaximumValueSafe<T>());
